...
function draw() {
  ...
  if (pantalla == "dispoResonancia") { //estado 7
    dispoResonancia();
  }
  //if (pantalla = "megafono") { //estado 8
  //  lindoFinal();
  //}
...
//function mousePressedM(){
//if (pantalla == "cantar") { //boton megafono
//    if (mouseX > 200 && mouseX < 500 && mouseY > 500 && mouseY < 550) {
//      pantalla ="megafono";
//    } else if (mouseX > 900 && mouseX < 1200 && mouseY > 500 && mouseY < 550) { //boton dispositivo de resonancia
